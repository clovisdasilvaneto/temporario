...
The following files are supplied as part of this distribution:
    ...
    LICENCE.txt             - Licensing conditions for Sinorcaish
    ...
    logo.html               - How to create a logo image using the GIMP
    template.html           - Template file you can modify for your site

Please  note  that this version  of the  Sinorcaish  stylesheet  does  NOT
include any sample images.   You can download a more complete distribution
of the Sinorcaish stylesheet from the official web site:
...
welcomed!  Please send these to:
    ...
    FTP:      ftp://ftp.zap.org.au/pub/styles/sinorcaish/
